...
void (CODEGEN_FUNCPTR *_ptrc_glGetObjectParameterivAPPLE)(GLenum objectType, GLuint name, GLenum pname, GLint * params) = NULL;
GLenum (CODEGEN_FUNCPTR *_ptrc_glObjectPurgeableAPPLE)(GLenum objectType, GLuint name, GLenum option) = NULL;
GLenum (CODEGEN_FUNCPTR *_ptrc_glObjectUnpurgeableAPPLE)(GLenum objectType, GLuint name, GLenum option) = NULL;
...
void (CODEGEN_FUNCPTR *_ptrc_glGetTexParameterPointervAPPLE)(GLenum target, GLenum pname, void ** params) = NULL;
void (CODEGEN_FUNCPTR *_ptrc_glTextureRangeAPPLE)(GLenum target, GLsizei length, const void * pointer) = NULL;

static int Load_APPLE_texture_range(void)
{
	int numFailed = 0;
	_ptrc_glGetTexParameterPointervAPPLE = (void (CODEGEN_FUNCPTR *)(GLenum, GLenum, void **))IntGetProcAddress("glGetTexParameterPointervAPPLE");
	if(!_ptrc_glGetTexParameterPointervAPPLE) numFailed++;
	_ptrc_glTextureRangeAPPLE = (void (CODEGEN_FUNCPTR *)(GLenum, GLsizei, const void *))IntGetProcAddress("glTextureRangeAPPLE");
...
static ogl_StrToExtMap ExtensionMap[83] = {
...
static int g_extensionMapSize = 83;
