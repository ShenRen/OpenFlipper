...
class FilePlaPlugin : public QObject, BaseInterface, FileInterface, LoadSaveInterface, LoggingInterface, ScriptInterface
{
   Q_OBJECT
  ...
  Q_PLUGIN_METADATA(IID "org.OpenFlipper.Plugins.Plugin-FilePla")
#endif
